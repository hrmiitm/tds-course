...
- A Python library live on [PyPI](https://pypi.org) ([Lab 1.1](./publish-python-library-pypi-uv.mdx)).
- A documented CLI with a PDF manual on [GitHub Pages](./uv-cli-tool-latex-docs.mdx) ([Lab 1.2](./uv-cli-tool-latex-docs.mdx)).
- A self-updating dashboard repo ([Lab 1.3](./bash-daily-project-summary.mdx)).
