...
|---|-------|-----------|----------------|
| 1 | [VS Code](./vscode.mdx) | Microsoft's free code editor | The de-facto editor of our industry |
| 2 | [UV — Python Package Manager](./uv.mdx) | Rust-powered `pip` + `venv` + `pyenv` replacement | 10–100× faster than pip |
| 3 | [Bash Scripting](./bash-scripting.mdx) | The Unix shell language | Glue for everything on Linux / macOS / CI |
| 4 | [Git & GitHub](./git-github.mdx) | Version control + collaboration | Every real project lives in Git |
| 5 | [SQLite](./sqlite.mdx) | File-based SQL database | Ships with Python; used by Firefox, iOS, airplanes |
| 6 | [HTTP Clients](./http-clients.mdx) | `curl`, `httpie`, Postman | Talk to any API before you write a line of Python |
| 7 | [Requestly](./requestly.mdx) | Browser HTTP interceptor | Mock/modify/redirect traffic without touching backend |
| 8 | [Data Formats](./data-formats.mdx) | JSON, YAML, TOML, Markdown, Base64, Unicode | The vocabulary of all modern APIs |
| 9 | [GitHub Pages](./github-pages.mdx) | Free static site hosting from GitHub | Publish docs, portfolios, apps |
| 10 | [LaTeX](./latex.mdx) | Professional typesetting | Publication-quality PDFs + math |

## Labs

You will build these three labs — each one ships something real to the internet.

1. **Lab 1.1 — [Publish a Python library to PyPI using UV](/labs/week-1/publish-python-library-pypi-uv.mdx)**
2. **Lab 1.2 — [UV CLI tool + LaTeX documentation PDF on GitHub Pages](/labs/week-1/uv-cli-tool-latex-docs.mdx)**
3. **Lab 1.3 — [Bash automation script — daily project summary](/labs/week-1/bash-daily-project-summary.mdx)**
